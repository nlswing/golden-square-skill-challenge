...
RSpec.describe DiaryEntry do
  ...
  describe "#reading_time" do
    context "given a wpm of some sensible number" do
      it "return the ceiling of number of minutes it takes to read the contents" do
  ...
  describe "#reading_chunk" do
    ...
    context "with a contents unreadable in the given minutes" do
      ...
      it "returns the nuext chunk, next time we are asked" do
        diary_entry = DiaryEntry.new("my_title", "one two three")
